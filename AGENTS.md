...
为孩子（**2026年9月15日出生**）每天自动生成中英文睡前故事各一篇。故事风格随孩子年龄分阶段自动调整。
...
| 路径 | 说明 |
|------|------|
| `C:\Users\Administrator\WorkBuddy\Claw\bedtime-story-app\stories.json` | **唯一的数据库** — 全部故事 JSON 数组，257 篇 |
...
| 阶段 | 时间 | 中文风格重点 | 英文风格重点 |
|------|------|-------------|-------------|
| **胎教期** | ~2026.9.15 | 冰波/金波诗意温柔、拟声词、等待/爱/守护 | Dr. Seuss 韵律 + McCloskey 自然拟声 + Mem Fox |
| **0-1 岁** | 2026.9.15~2027.9.15 | 张秋生/孙敬修、极简句、感官启蒙、童谣风 | 极简词汇、重复拟声、McCloskey + Mem Fox 动物日常 |
| **1-3 岁** | 2027.9.15~2029.9.15 | 汤素兰/孙敬修、生活习惯/情绪认知、绘本大师风 | 重复句型、Seuss + 芝麻街 + McCloskey + Donaldson |
| **3-6 岁** | 2029.9.15~2032.9.15 | 郑渊洁/汤素兰、轻松冒险、幽默想象、科普叙事 | Dahl 转折幽默 + McCloskey 小镇冒险 + Donaldson 反转 |
| **6 岁+** | 2032.9.15+ | 全部风格完整融合、深层寓意、双语对照 | Twain 冒险 + Dahl 黑色幽默 + 全部风格完整融合 |
...
- [x] 2026-09-15 宝宝出生：`CHILD_BIRTHDAY` 已由预产期 2026-09-22 改为 2026-09-15，故事风格自出生日起自动切换为 0-1 岁
- [x] 2026-09-15 ~ 09-21 已发布的 28 篇胎教期故事已改写为「出生后 0-1 岁」口吻（含当当 ep27 改标）
- [x] 2026-09-22 ~ 09-30 每日 4 篇（中/英日常 + 中/英科学）共 36 篇已补齐，当当 ep28/ep29 同步

## 当前数据统计

- 总故事数：**257 篇**（146 中文 + 111 英文）
- 覆盖日期：2026-07-16 ~ 2026-09-30
- 年龄段：**2026-09-14 及之前为胎教期；2026-09-15（出生日）起为 0-1 岁**，0-1 岁共 67 篇（28 篇改写 + 36 篇新增 + 当当 ep27/28/29）
